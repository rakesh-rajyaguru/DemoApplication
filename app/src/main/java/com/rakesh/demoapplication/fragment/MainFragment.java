...
import com.rakesh.demoapplication.CropResultActivity;
...
public final class MainFragment extends Fragment
    ...
    public void updateCurrentCropViewOptions() {
        ...
        ((CropFragment) getParentFragment()).setCurrentOptions(options);
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        inflater.inflate(R.menu.crop_menu_option, menu);
    }
    ...
    public void onAttach(Activity activity) {
        ...
        ((CropFragment) getParentFragment()).setCurrentFragment(this);
    }
